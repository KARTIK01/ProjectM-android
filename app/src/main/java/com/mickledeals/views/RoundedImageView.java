...
//        TypedArray a = context.obtainStyledAttributes(attrs, com.makeramen.roundedimageview.RoundedImageView, defStyle, 0);
...
//        cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius, -1);
        borderWidth = Utils.getPixelsFromDip(1f, context.getResources());
        ...
        borderColor = ColorStateList.valueOf(context.getResources().getColor(R.color.light_divider));
