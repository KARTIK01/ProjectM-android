 ...
 */
public class AutofitTextView extends TextView implements com.mickledeals.views.AutofitHelper.OnTextSizeChangeListener {

    private com.mickledeals.views.AutofitHelper mHelper;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        mHelper = com.mickledeals.views.AutofitHelper.create(this, attrs, defStyle)
     ...
     */
    public com.mickledeals.views.AutofitHelper getAutofitHelper() {
        return mHelper;
    }
